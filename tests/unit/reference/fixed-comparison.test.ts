...
describe('fixed WebGPU comparison metadata', () => {
  ...
  it.each([
    [
      'prompt',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.prompt = 'other';
      },
    ],
    [
    ...
    [
      'assembled prompt',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.assembledPrompt = 'other';
      },
    ],
    [
      'conditional tokens',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.tokenIds[0][1] = 0;
      },
    ],
    [
      'unconditional tokens',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.tokenIds[1][1] = 0;
      },
    ],
    [
      'global guidance',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.globalGuidance = 1.6;
      },
    ],
    [
      'semantic top-k',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.semanticTopK = 49;
      },
    ],
    [
      'residual top-k',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.residualTopK = 49;
      },
    ],
    [
      'temperature',
    ...
    [
      'sampler revision',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.samplerRevision = 'other';
      },
    ],
    [
      'flow guidance',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.flowGuidance = 1.8;
      },
    ],
    [
      'flow steps',
    ...
    [
      'schedule',
      (value: ReturnType<typeof fixedMetadata>) => {
        value.flowScheduleRevision = 'other';
      },
    ],
  ...
  it('does not label changed input, sampling, seed, or duration as the fixed case', () => {
    ...
    expect(
      createFixedComparisonMetadata({
        input: fixedInput,
        sampling: { ...fixedSampling, temperature: 0.9 },
        seed: 7,
        durationSeconds: 10,
        plan,
        ...provenance,
